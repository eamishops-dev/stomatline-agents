...
0. Прочитай останні коментарі Аміра у своїй Asana-задачі `[Agent] <Назва>`: «Прийняти» — розвивай напрям; «Відхилити» — не повторюй тип; «Доопрацювати» — доопрацюй ту саму фігуру замість нової.
...
- **Єдине місце оцінки — Asana.** Амір обдумує кожну фігуру і коментує її в задачі. Агент читає ці коментарі на кроці 0 наступного циклу. Окремого файлу уроків немає.
